        ...
        public void RunEffect(Player player, Player opponent)
        {
            switch(CardName)
            {
                ...
                case "Demonic Pact":
                    ...
                    opponent.BrickLevel--; opponent.MagicLevel--; opponent.DungeonLevel--;
                    break;
                case "Earthquake":
                    opponent.WallLevel -= 12;
                    break;
                case "Force Field":
                    player.WallLevel += 7;
                    break;
                ...
                case "Mole Mercenaries":
                    opponent.WallLevel -= 10;
                    opponent.TowerLevel -= 2;
                    break;
                case "Pixie Archers":
                    opponent.TowerLevel -= 3;
                    break;
                //case CardName:
                //    break;
                //case CardName:
